                                        ...
                                        <div id="productslider-1" class="product-carousel carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img class="d-block" src="{{asset('backend')}}/images/eco-slider-img-1.png" alt="First slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block" src="{{asset('backend')}}/images/eco-slider-img-2.png" alt="Second slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block" src="{{asset('backend')}}/images/eco-slider-img-3.png" alt="Third slide">
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="product-thumbnail">
                                        <div class="product-img-head">
                                            <div class="product-img">
                                                <img src="{{asset('backend')}}/images/eco-product-img-1.png" alt="" class="img-fluid"></div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="product-thumbnail">
                                        <div class="product-img-head">
                                            <div class="product-img">
                                                <img src="{{asset('backend')}}/images/eco-product-img-2.png" alt="" class="img-fluid"></div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="product-thumbnail">
                                        <div class="product-img-head">
                                            <div class="product-img">
                                                <img src="{{asset('backend')}}/images/eco-product-img-3.png" alt="" class="img-fluid"></div>
