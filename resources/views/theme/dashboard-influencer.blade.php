	                                ...
	                                <div class="row">
	                                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12">
	                                        <div class="text-center">
	                                            <img src="{{asset('backend')}}/images/avatar-1.jpg" alt="User Avatar" class="rounded-circle user-avatar-xxl">
	                                            </div>
	                                        </div>
	                                ...
	                                <div class="campaign-table table-responsive">
	                                    <table class="table">
	                                        ...
	                                        <tbody>
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="{{asset('backend')}}/images/dribbble.png" alt="user" width="35"></div>
	                                                </td>
	                                            ...
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="{{asset('backend')}}/images/github.png" alt="user" width="35"></div>
	                                                </td>
	                                            ...
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="{{asset('backend')}}/images/dropbox.png" alt="user" width="35"></div>
	                                                </td>
	                                            ...
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="{{asset('backend')}}/images/bitbucket.png" alt="user" width="30"></div>
	                                                </td>
	                                            ...
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="{{asset('backend')}}/images/mail_chimp.png" alt="user" width="30"></div>
	                                                </td>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card campaign-card text-center">
	                                <div class="card-body">
	                                    <div class="campaign-img"><img src="{{asset('backend')}}/images/dribbble.png" alt="user" class="user-avatar-xl"></div>
	                            ...
	                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                <div class="card campaign-card text-center">
	                                    <div class="card-body">
	                                        <div class="campaign-img"><img src="{{asset('backend')}}/images/github.png" alt="user" class=" user-avatar-xl"></div>
	                                            <div class="campaign-info">
	                                                <h3 class="mb-1">Campaigns Name</h3>
	                                ...
	                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                    <div class="card campaign-card text-center">
	                                        <div class="card-body">
	                                            <div class="campaign-img"><img src="{{asset('backend')}}/images/slack.png" alt="user" class="user-avatar-xl"></div>
	                                                <div class="campaign-info">
	                                                    <h3 class="mb-1">Campaigns Name</h3>
	                                    ...
	                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                        <div class="card campaign-card text-center">
	                                            <div class="card-body">
	                                                <div class="campaign-img"><img src="{{asset('backend')}}/images/mail_chimp.png" alt="user" class="user-avatar-xl"></div>
	                                                    <div class="campaign-info">
	                                                        <h3 class="mb-1">Campaigns Name</h3>
