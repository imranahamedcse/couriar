...
@section('title','Hub Payment | Edit')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href=" " class="breadcrumb-link">{{ __('hub_payment.title') }}</a></li>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('from_account') is-invalid @enderror" name="from_account" >
                                        ...
                                        @if ($account->gateway == 1)
                                                <option value="{{ $account->id }}" @if($account->id == $singlePayment->from_account) selected @endif>Cash</option>
...
@push('scripts')
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
     <script src="{{ asset('backend/js/merchantmanaage/create.js') }}"></script>
@endpush
