...
@section('title','Hub Payment | List')
@section('maincontent')
<!-- ============================================================== -->
<!-- wrapper  -->
<!-- ============================================================== -->
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="row pl-4 pr-4 pt-4">
                    <div class="col-8">
                        <p class="h3">{{ __('hub_payment.title') }}</p>
                    </div>
                        ...
                        <table class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if(isset($payment->referencefile))<a href="{{ asset($payment->referencefile->original) }}" download="">Download</a>@endif</td>
