...
@section('title','Merchant/Hub/Deliveryman reports | List')
@section('maincontent')
<!-- ============================================================== -->
<!-- wrapper  -->
<!-- ============================================================== -->
            ...
            <div class="card" style="margin-bottom: 0px">
                <div class="card-body">
                    <form action="{{route('reports.mhd.reports')}}"  method="GET">
                        ...
                        <div class="row">
                            <div class="form-group col-12 con-md-3">
                            ...
                            {{-- merchant --}}
                            <div class="form-group merchant_search col-12 con-md-3" id="merchantType"  >
                            ...
                            {{-- Hub Search --}}
                            <div class="form-group hub_search col-12 con-md-3" id="hubType">
                            ...
                            {{-- delivery man --}}
                            <div class="form-group delivery_man_search col-12 con-md-3" id="deliverymanType">
                                ...
                                <div class="form-group col-12 con-md-3 pt-1">
...
{{-- <script src="{{ asset('backend/js/income/custom.js') }}"></script> --}}
