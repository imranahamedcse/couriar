                    ...
                    <form action="{{route('users.filter')}}"  method="GET">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-3" >
                                ...
                                <input type="text" id="name" name="name" placeholder="User name"  class="form-control" value="{{old('name', $request->name)}}">
                                @error('name')
                            ...
                            <div class="form-group col-12 col-md-3" >
                                ...
                                <input type="text" id="email" name="email" placeholder="User email"  class="form-control" value="{{old('email', $request->email)}}">
                                @error('email')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-12 col-md-3">
                                ...
                                <input type="text" id="phone" name="phone" placeholder="phone"  class="form-control" value="{{old('phone', $request->phone)}}">
                                @error('phone')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
