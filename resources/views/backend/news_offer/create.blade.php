...
<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h2 class="pageheader-title">{{ __('news_offer.create_news_offer') }}</h2>
                    <form action="{{route('news-offer.store')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        @csrf
                        <div class="row">
