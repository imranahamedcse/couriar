...
<!-- Data table css  -->
@push('styles')
    <link rel="stylesheet" href="{{asset('backend')}}/vendor/datatables/css/dataTables.bootstrap4.css">
    <link rel="stylesheet" href="{{asset('backend')}}/vendor/datatables/css/buttons.bootstrap4.css">
    <link rel="stylesheet" href="{{asset('backend')}}/vendor/datatables/css/buttons.bootstrap4.css">
    <link rel="stylesheet" href="{{asset('backend')}}/vendor/datatables/css/select.bootstrap4.css">
    <link rel="stylesheet" href="{{asset('backend')}}/vendor/datatables/css/fixedHeader.bootstrap4.css">
