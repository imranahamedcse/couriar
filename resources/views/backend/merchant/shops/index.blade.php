                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($shop->default_shop == \App\Enums\Status::ACTIVE)
                                        <span class="badge badge-pill badge-primary">{{ __('merchantshops.default') }}</span>
                                    @else
                                        <a href="{{ route('merchant.shops.default',['merchant_id' => $shop->merchant_id,'id' => $shop->id]) }}" class=" default_shop_button">{{ __('merchantshops.add_default') }}</a>
                                    @endif
