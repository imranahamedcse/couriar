        ...
        <table style="width:100%;height:50px;max-width:650px;margin: auto;">
                <tr>
                    ...
                    <td style="text-align: center;padding:30px 10px">
                        <a href="{{ url('/') }}"><img src="{{ asset(@settings()->rxlogo->original) }}" style="height: 50px;"/></a>
                    </td>
                </tr>
        </table>
        ...
        <table style="width:100%;height:50px;max-width:650px;margin: auto;background-color: white;">
                <tr>
                    <td style="padding:30px;line-height: 1.5;" colspan="2">
                        ...
                        <p style="color: #5969ff;font-weight: bold;">Your Business Information :</p>
                        ...
                        <p>Please login your panel
                            ...
                            style="background-color: #5969ff;color: white; margin-left:10px;padding: 7px 15px; border: none;text-decoration: none;border-radius: 3px;"
                            >Login</a>
                        </p>
                ...
                <tr>
                    <td style="width: 50%; text-align: right;padding: 10px 10px 30px 10px;">
                       <a href="#"> <img src="{{ asset('backend/images/social-media') }}/play butttom.png" style="width:200px;"/></a>
                    </td>
                    <td style="width: 50%;text-align: left;padding: 10px 10px 30px 10px;">
                        <a href="#"><img src="{{ asset('backend/images/social-media') }}/istore.png" style="width:200px" /></a>
                    </td>
                </tr>
        </table>
        <table style="width:100%;height:50px;max-width:650px;margin: auto; ">
                <tr>
                    <td style="text-align: center;">
                        <ul>
                            <li> <a> <img src="{{ asset('backend/images/social-media') }}/brand-b.png" style="width: 30px;" />  </a> </li>
                            <li> <a> <img src="{{ asset('backend/images/social-media') }}/brand-c.png" style="width: 30px;" />  </a> </li>
                            <li> <a> <img src="{{ asset('backend/images/social-media') }}/brand-d.png" style="width: 30px;" />  </a> </li>
                            <li> <a> <img src="{{ asset('backend/images/social-media') }}/brand-e.png" style="width: 30px;" />  </a> </li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td style="padding:0px 30px;text-align: center;">
                        <p style="font-size: 13px;">
                            Copyright © 2020 {{ @settings()->name }}. All rights reserved. Template Made By <a href="{{ url('/') }}">{{ @settings()->name }}</a>.
                        </p>
                    </td>
                </tr>
        </table>
