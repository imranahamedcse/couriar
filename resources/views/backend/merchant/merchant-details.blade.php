...
<ul class="list-group">
    ...
    <li class="list-group-item profile-list-group-item justify-content-center">
        ...
        <span class="float-right profile-list-group-item-addresss"><img src="{{ asset($singleMerchant->nid) }}" width="100px" /></span>
    </li>

    <li class="list-group-item profile-list-group-item justify-content-center">
        <span class="float-left font-weight-bold">{{ __('levels.trade_license') }}</span>
        <span class="float-right profile-list-group-item-addresss"><img src="{{ asset($singleMerchant->trade) }}" width="100px" /></span>
    </li>
