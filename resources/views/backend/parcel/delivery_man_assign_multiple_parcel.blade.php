<div class="modal fade" id="delivery_man_assign_multiple_parcel"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content" id="data-modal">
        ...
        <form action="{{ route('parcel.delivery-man-assign-multiple-parcel') }}" method="post">
            @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="delivery_man_assign_multiple_parcel_button" class="btn btn-primary">Submit</button>
            </div>
        </form>
