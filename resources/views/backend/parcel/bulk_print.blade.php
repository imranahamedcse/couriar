...
<body>
        <div class="print" style="text-align: right" >
            <a href="{{ route('parcel.index') }}" class="btn-danger">Close</a>
        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach($parcels as $key => $parcel)
                                        <tr @if($i%2 == 0) class="odd" @endif>
                                            ...
                                            @endif
                                            <td data-label="delivery_date ">{{ dateFormat($parcel->delivery_date) }}</td>
