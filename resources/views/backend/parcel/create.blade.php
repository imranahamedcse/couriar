                    ...
                    <form action="{{route('parcel.store')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-6">
                                ...
                                <textarea id="customer_address" name="customer_address" class="form-control" required="">{{ old('customer_address') }}</textarea>
...
@push('scripts')
    ...
    <script src="{{ asset('backend/js/parcel/create.js') }}"></script>
