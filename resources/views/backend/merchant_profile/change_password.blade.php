...
@section('title','Merchant Profile | Update')
@section('maincontent')
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="old_password" type="password" name="old_password" data-parsley-trigger="change" placeholder="Enter old password" autocomplete="off" class="form-control" value="{{old('old_password')}}" require>
                                    @error('old_password')
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="new_password" type="password" name="new_password" data-parsley-trigger="change" placeholder="Enter new password" autocomplete="off" class="form-control" value="{{old('new_password')}}" require>
                                    @error('new_password')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="confirm_password" type="password" name="confirm_password" data-parsley-trigger="change" placeholder="Enter confirm password" autocomplete="off" value="{{old('confirm_password')}}" class="form-control" require>
