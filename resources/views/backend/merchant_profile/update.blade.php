                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-3 mt-3 mt-md-0">
                                            <img src="{{asset($merchat->user->image)}}" alt="user" class="rounded" width="70" height = "70">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-3 pt-4">
                                            <img src="{{asset($merchat->nid)}}" alt="user" class="rounded" width="100" height = "65">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-3 pt-4">
                                            <img src="{{asset($merchat->trade)}}" alt="user" class="rounded" width="100" height = "65">
                                        </div>
                                    </div>
                                </div>
                            </div>
