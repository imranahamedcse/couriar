...
@section('title','Assets Category | List')
@section('maincontent')
<!-- ============================================================== -->
<!-- wrapper  -->
<!-- ============================================================== -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @if(hasPermission('asset_category_delete') == true)
                                                    <form id="delete" value="Test" action="{{route('asset-category.delete',$assetcategory->id)}}" method="POST" data-title="{{ __('delete.asset_category') }}">
                                                        @method('DELETE')
                                                        @csrf
