...
class Merchant extends Model
{
    ...
    */
    ...
    {
        if (!empty($this->licensefile->original['original']) && file_exists($this->licensefile->original['original'])) {
    ...
    {
        if (!empty($this->nidfile->original['original']) && file_exists($this->nidfile->original['original'])) {
