    ...
    public function store($request)
    {
        ...
        try {
            ...
            elseif($request->account_head_id == 2):
                ...
                // $hub_statements->hub_id           = $request->hub_id;
                ...
                // $hub_statements->note             = __('hub.cash_received_from_delivery_man');
                // $hub_statements->save();

                //add balance in hub current balance
    ...
    public function update($id, $request)
    {
        try {
            ...
            elseif($inc->account_head_id == 2):
                ...
                //reverse hub statements
                // $hub_statements                   = new HubStatement();
                // $hub_statements->hub_id           = $inc->hub_id;
                // $hub_statements->delivery_man_id  = $inc->delivery_man_id;
                // $hub_statements->type             = AccountHeads::EXPENSE;
                // $hub_statements->amount           = $inc->amount;
                // $hub_statements->date             = $inc->date;
                // $hub_statements->note             = __('hub.cash_received_from_delivery_man');
                // $hub_statements->save();

                // //reverse balance in hub current balance
        ...
        try {
            ...
            elseif($income->account_head_id == 2):
                ...
                //deliveryman  statements
                    ...
                    //reverse hub statements
                    // $hub_statements                   = new HubStatement();
                    // $hub_statements->hub_id           = $income->hub_id;
                    // $hub_statements->delivery_man_id  = $income->delivery_man_id;
                    // $hub_statements->type             = AccountHeads::EXPENSE;
                    // $hub_statements->amount           = $income->amount;
                    // $hub_statements->date             = $income->date;
                    // $hub_statements->note             = __('hub.cash_received_from_delivery_man');
                    // $hub_statements->save();
